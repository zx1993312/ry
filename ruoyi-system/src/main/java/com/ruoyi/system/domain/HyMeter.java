...
public class HyMeter extends BaseEntity
{
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("meterSerialNum", getMeterSerialNum())
            .append("meterName", getMeterName())
            .append("initialRead", getInitialRead())
            .append("meterStrNum", getMeterStrNum())
            .append("meterEndNum", getMeterEndNum())
            .append("transfRatio", getTransfRatio())
            .append("reverseNot", getReverseNot())
            .append("strappingType", getStrappingType())
            .append("meterReadDate", getMeterReadDate())
            .append("magnification", getMagnification())
            .append("newMeterConsumption", getNewMeterConsumption())
            .append("oldMeterConsumption", getOldMeterConsumption())
            .append("attritionRate", getAttritionRate())
            .append("unitPrice", getUnitPrice())
            .append("amountPrice", getAmountPrice())
            .append("abnormalPrompt", getAbnormalPrompt())
            .append("customerName", getCustomerName())
            .append("freezeNot", getFreezeNot())
            .append("sourceMeter", getSourceMeter())
