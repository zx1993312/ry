...
public class HyVatAudit extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("id", getId())
				.append("areaName", getAreaName()).append("projectNum", getProjectNum())
				.append("entryName", getEntryName()).append("taxScale", getTaxScale())
				.append("expenseAccount", getExpenseAccount()).append("taxRate", getTaxRate())
				.append("timeStr", getTimeStr()).append("timeEnd", getTimeEnd()).append("auditStatus", getAuditStatus())
				.append("estateRecord", getEstateRecord()).append("taxRateRecord", getTaxRateRecord()).toString();
	}
}
