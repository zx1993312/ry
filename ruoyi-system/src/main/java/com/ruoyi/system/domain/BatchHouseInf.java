...
public class BatchHouseInf extends BaseEntity {

	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = 2177685420861275552L;
	...
	public String toString() {
		return "BatchHouseInf [id=" + id + ", houseNumber=" + houseNumber + ", houseName=" + houseName
				+ ", builtUpArea=" + builtUpArea + ", groupArea=" + groupArea + ", unit=" + unit + ", floor=" + floor
				+ ", sameUnitNumber=" + sameUnitNumber + ", areaType=" + areaType + ", bilingArea=" + bilingArea
				+ ", insideArea=" + insideArea + ", sharedArea=" + sharedArea + ", gardenArea=" + gardenArea
				+ ", basementArea=" + basementArea + ", sharedLobbyArea=" + sharedLobbyArea + ", sharedLayersArea="
				+ sharedLayersArea + ", shareRatio=" + shareRatio + ", buildingStructure=" + buildingStructure
				+ ", parametersPer=" + parametersPer + ", houseLayout=" + houseLayout + ", floorHeight=" + floorHeight
				+ ", natureProperty=" + natureProperty + ", natureUse=" + natureUse + ", usageStatus=" + usageStatus
				+ ", occupancyStatus=" + occupancyStatus + ", deliveryStatusBefore=" + deliveryStatusBefore
				+ ", deliveryStatus=" + deliveryStatus + ", changeDate=" + changeDate + ", changePerson=" + changePerson
				+ ", remark=" + remark + ", houseType=" + houseType + ", salesStatus=" + salesStatus
				+ ", purchaseContract=" + purchaseContract + ", marketingNum=" + marketingNum + ", buildingId="
				+ buildingId + ", ownerId=" + ownerId + ", hyBuilding=" + hyBuilding + ", hyProject=" + hyProject
				+ ", hyGroupRegistration=" + hyGroupRegistration + "]";
	}
