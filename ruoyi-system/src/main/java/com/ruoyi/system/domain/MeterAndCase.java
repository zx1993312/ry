...
public class MeterAndCase {
	 ...
	 private static final long serialVersionUID = 1L;
		...
		public String toString() {
			return "MeterAndCase [id=" + id + ", houseNum=" + houseNum + ", meterType=" + meterType
					+ ", meterSerialNum=" + meterSerialNum + ", meterName=" + meterName + ", initialRead=" + initialRead
					+ ", transfRatio=" + transfRatio + ", reverseNot=" + reverseNot + ", strappingType=" + strappingType
					+ ", meterCaseName=" + meterCaseName + ", meterCasePosition=" + meterCasePosition + ", meterSerial="
					+ meterSerial + ", getId()=" + getId() + ", getHouseNum()=" + getHouseNum() + ", getMeterType()="
					+ getMeterType() + ", getMeterSerialNum()=" + getMeterSerialNum() + ", getMeterName()="
					+ getMeterName() + ", getTransfRatio()=" + getTransfRatio() + ", getReverseNot()=" + getReverseNot()
