 ...
 */
@Controller
@RequestMapping("/system/collectionTimeBillSet")
@Api(tags = "票据设置Controller")
public class HyBillSetTimeController extends BaseController {
	private String prefix = "system/collectionTimeBillSet";
