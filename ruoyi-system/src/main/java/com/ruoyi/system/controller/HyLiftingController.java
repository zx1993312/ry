...
public class HyLiftingController extends BaseController {
	 ...
	 * App端新增保存提料人
	 */
	@RequiresPermissions("system:lifting:appAddHyLiftingSave")
	@Log(title = "提料人", businessType = BusinessType.INSERT)
	@PostMapping("/appAddHyLiftingSave")
	@ResponseBody
	public AjaxResult appAddHyLiftingSave(HyLifting hyLifting) {
		return toAjax(hyLiftingService.appAddHyLiftingSave(hyLifting));
	}
