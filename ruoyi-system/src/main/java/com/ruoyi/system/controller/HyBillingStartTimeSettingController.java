 ...
 */
@Controller
@RequestMapping("/system/billingStartTimeSetting")
@Api(tags = "费用项目Controller")
public class HyBillingStartTimeSettingController extends BaseController {
	private String prefix = "system/billingStartTimeSetting";
