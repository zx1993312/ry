...
@Controller
@CrossOrigin
@RequestMapping("/system/selectRegistration")
@Api(tags = "业主资料登记Controller")
public class HyOwnerSelectRegistrationController extends BaseController {
	private String prefix = "system/selectRegistration";
