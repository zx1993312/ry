...
@Controller
@CrossOrigin
@RequestMapping("/system/updateSelectMeter")
@Api(tags = "抄表设置Controller")
public class HyUpdateSelectMeterController extends BaseController {
	private String prefix = "system/updateSelectMeter";
