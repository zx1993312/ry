 ...
 */
@Controller
@RequestMapping("/system/customerStandardsCost")
@Api(tags = "费用项目Controller")
public class HyCustomerStandardsController extends BaseController {
	private String prefix = "system/customerStandardsCost";
	 ...
	 */
	@GetMapping("/add")
	public String add(String standardName) {
