 ...
 */
@Controller
@RequestMapping("/system/transferinf")
@Api(tags = "房屋转让Controller")
public class HyHouseInfTransferController extends BaseController {
	private String prefix = "system/transferinf";
