 ...
 */
@Controller
@RequestMapping("/system/disPublicDistrictMeter")
@Api(tags = "抄表设置Controller")
public class HyDisPulbicDistriceMeterController extends BaseController {
	private String prefix = "system/disPublicDistrictMeter";
