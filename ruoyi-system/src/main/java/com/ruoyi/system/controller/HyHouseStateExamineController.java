 ...
 */
@Controller
@RequestMapping("/system/houseStateExamine")
@Api(tags = "业主资料登记Controller")
public class HyHouseStateExamineController extends BaseController {
	private String prefix = "system/houseStateExamine";
