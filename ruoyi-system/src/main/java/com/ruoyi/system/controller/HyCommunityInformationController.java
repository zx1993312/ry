...
public class HyCommunityInformationController extends BaseController{
	...
	@RequiresPermissions("system:communityInformation:list")
	@PostMapping("/list")
	@ResponseBody
	...
	@RequiresPermissions("system:communityInformation:export")
    ...
    public AjaxResult export(HyCommunityInformation hyCommunityInformation)
	{
		...
		return util.exportExcel(list,"communityInformation");
	}
	/**
	 * 新增社区咨询
	 * @return
	...
	@RequiresPermissions("system:communityInformation:add")
	...
	@RequiresPermissions("system:communityInformation:edit")
	...
	@RequiresPermissions("system:communityInformation:remove")
