 ...
 */
@Controller
@RequestMapping("/system/remission")
@Api(tags = "费用减免Controller")
public class HyFeeRemissionController extends BaseController
{
    private String prefix = "system/remission";
    ...
    @ApiOperation("费用减免")
    @ApiImplicitParams({ 
		@ApiImplicitParam(name = "hyFeeRemission", value = "项目实体类hyFeeRemission", required = true),
	})
