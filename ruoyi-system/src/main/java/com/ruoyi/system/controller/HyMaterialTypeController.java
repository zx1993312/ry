...
@Api(tags = "物料类型Controller")
public class HyMaterialTypeController extends BaseController {
	...
	public TableDataInfo list(HyMaterial hyMaterial) {
		startPage();
		List<SysDictData> list = dictTypeService.selectDictDataByType("hy_material_type");
