 ...
 */
@Controller
@RequestMapping("/system/collectioneEndTime")
@Api(tags = "费用项目Controller")
public class HyCollectionEndTimeController extends BaseController {
	private String prefix = "system/collectioneEndTime";
