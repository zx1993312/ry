 ...
 */
@Controller
@RequestMapping("/system/parkingPossession")
@Api(tags = "车位资料 Controller")
public class HyParkingInfControllerPossession extends BaseController {
	private String prefix = "/system/parkingPossession";
