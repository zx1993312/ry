 ...
 */
@Controller
@RequestMapping("/system/projectChargeStandard")
@Api(tags = "费用项目Controller")
public class HyProjectChargeStandardController extends BaseController {
	private String prefix = "system/projectChargeStandard";
