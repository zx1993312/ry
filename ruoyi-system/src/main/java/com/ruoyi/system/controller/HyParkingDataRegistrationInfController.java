 ...
 */
@Controller 
@RequestMapping("/system/parkingDataRegistration")
@Api(tags = "车位资料 Controller")
public class HyParkingDataRegistrationInfController extends BaseController {
	private String prefix = "system/parkingDataRegistration";
