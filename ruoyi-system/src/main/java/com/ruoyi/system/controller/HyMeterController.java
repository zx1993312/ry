...
public class HyMeterController extends BaseController
{
    ...
    @ApiOperation("抄设置")
    @ApiImplicitParams({ 
		@ApiImplicitParam(name = "hyMeter", value = "项目实体类hyMeter", required = true),
	})
    ...
    @Log(title = "抄设置", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    @ResponseBody
    ...
    @Log(title = "抄设置", businessType = BusinessType.INSERT)
    @PostMapping("/add")
    @ResponseBody
    ...
    @Log(title = "抄设置", businessType = BusinessType.UPDATE)
    @PostMapping("/edit")
    @ResponseBody
    ...
    @Log(title = "抄设置", businessType = BusinessType.DELETE)
    @PostMapping( "/remove")
    @ResponseBody
