...
@Controller
@CrossOrigin
@RequestMapping("/system/parkingInformation")
@Api(tags = "车位资料 Controller")
public class HyParkingInformationController extends BaseController {
	private String prefix = "system/parkingInformation";
